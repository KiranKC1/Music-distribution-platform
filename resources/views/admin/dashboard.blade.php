            ...
            <div class="card">
                ...
                @endif
                    ...
                    <div class="text-center">
                            <div class="row w-100">
                                    <div class="col-md-4">
                                    <a href="{{URL::to('admin/unshipped_codes')}}" style="text-decoration:none;">
                                    ...
                                    <div class="col-md-4">
                                    <a href="{{URL::to('admin/shipped_codes')}}" style="text-decoration:none;">
                                    ...
                                    <div class="col-md-4">
                                    <a href="{{URL::to('admin/redeemed_codes')}}" style="text-decoration:none;">
