...
Sizes: [
	...
	<head>
		...
		<title>Pahenlo batti Muni (Bichitra) Album Download link</title>
		<style type="text/css">
			/* RESET STYLES */
	...
	<body style="margin-top:20px;" bgcolor="#070E18" leftmargin="0" marginwidth="0" topmargin="30" marginheight="0" offset="0">
		...
		<center style="background-color:#E1E1E1;">
			<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable" style="padding-top:50px;table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;">
				<tr>
						...
						<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="100%" id="emailBody">
							...
							<tr>
								<td align="center" valign="top">
									...
									-->
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#070E18">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<!--
